...
const styles = StyleSheet.create({
  ...
  box: {
    width: '31.5%', flexGrow: 1, alignItems: 'center', paddingVertical: 16,
    backgroundColor: colors.bgPanel, borderRadius: 18,
  },
  boxActive: { backgroundColor: colors.text },
  ...
  boxTitleActive: { color: colors.ink },
  row: {
  ...
  input: {
    ...
    borderRadius: 12, borderWidth: 0, paddingHorizontal: 12, paddingVertical: 8,
    minWidth: 120,
  },
  ...
  segmented: { flexDirection: 'row', borderRadius: 999, overflow: 'hidden', backgroundColor: colors.bgPanelAlt },
  segment: { paddingVertical: 7, paddingHorizontal: 16 },
  segmentActive: { backgroundColor: colors.text, borderRadius: 999 },
